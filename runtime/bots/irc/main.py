...
while 1:
    ...
    for line in temp:
        ...
        if msg == "$help": send("PRIVMSG {} :Avalible commands: $hello, $ping, $youtube, $github.\r\n".format(CHANNEL).encode("utf-8"))
        if msg.startswith("$help "):
            ...
            if tokens[1] == "server": send("PRIVMSG {} :Syntax: $server  Action: Gets the status of Dove's Minecraft Server.\r\n".format(CHANNEL).encode("utf-8"))
